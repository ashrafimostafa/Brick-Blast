...
Current release targeted for F-Droid: **v1.5.0** (versionCode **8**).
...
- `BrickBlast-1.5.0-fdroid.apk` (FOSS, no ads)
- `BrickBlast-1.5.0-store.apk` (store build with ads)
...
4. If the app is **already on F-Droid**, open an update MR with the new `1.5.0` build entry and updated `CurrentVersion` / `CurrentVersionCode`
...
- [ ] `commit: v1.5.0` tag exists on the default branch
