...
Current release targeted for F-Droid: **v1.5.1** (versionCode **9**).
...
- `BrickBlast-1.5.1-fdroid.apk` (FOSS, no ads)
- `BrickBlast-1.5.1-store.apk` (store build with ads)
...
4. If the app is **already on F-Droid**, open an update MR with the new `1.5.1` build entry and updated `CurrentVersion` / `CurrentVersionCode`
...
- [ ] `commit: v1.5.1` tag exists on the default branch
