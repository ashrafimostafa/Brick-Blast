package com.example.brickblast.game.renderer
...
import com.example.brickblast.game.particle.Particle
import com.example.brickblast.game.particle.ParticleType
...
object GameRenderer {
    ...
    private fun DrawScope.renderDestroyingBrick(
        brick: com.example.brickblast.domain.model.Brick,
        cx: Float,
        cy: Float
    ) {
